...
*/
#ifndef __QUICKDRAWTYPESEXTRACTS__
#define __QUICKDRAWTYPESEXTRACTS__
...
#if __MACH__
#if defined(__cplusplus) and not(defined(__QUICKDRAW__))
...
#endif /* __QUICKDRAWTYPESEXTRACTS__ */
