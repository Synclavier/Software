...
void CXPLFloating::assign_ratio(int slNumerator, int slDenominator) {
	...
	//	set the mantissa
	mData.mantissa = (ullNumerator << (24 - scale_exponent)) / ulDenominator;
	//	round if necessary
...
void CSynclSFHeader::set_rates(double dSampleRate) {
	long	sample_rate = (long) (dSampleRate + .5);
